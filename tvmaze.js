...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var params, endpoint, response, data, shows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    params = new URLSearchParams({ q: term });
                    endpoint = "".concat(BASE_URL, "/search/shows?").concat(params);
                ...
                case 2:
                    ...
                    shows = data.map(function (showAndRatingObject) {
                        var showApiData = showAndRatingObject.show;
                        var show = {
                            id: showApiData.id,
